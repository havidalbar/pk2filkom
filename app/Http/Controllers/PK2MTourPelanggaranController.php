...
class PK2MTourPelanggaranController extends Controller
{
        ...
        if (isset($nim_index) && isset($ringan_index) && isset($sedang_index) && isset($berat_index)) {
            ...
            try {
                ...
                for ($i = 1; $i < count($spreadsheetArray); $i++) {
                    ...
                    PK2MTourPelanggaran::find($data_row[$nim_index])->update([
    ...
    public function update(Request $request, $nim)
    {
        ...
        return redirect()->route('panel.kegiatan.pkm.pelanggaran.index')->with('alert-success', 'Berhasil mengubah data keaktifan PK2M Tour');
    }
    ...
    public function destroy($nim)
    {
        ...
        return redirect()->route('panel.kegiatan.pkm.pelanggaran.index')->with('alert-success', 'Berhasil menghapus data keaktifan PK2M Tour');
    }
}
