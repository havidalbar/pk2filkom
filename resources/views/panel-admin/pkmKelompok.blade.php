            ...
            <table class="m-datatable" id="html_table" width="100%">
                <thead>
                    <tr>
                        ...
                        <th title="Anggota ke - 1">
                            Anggota ke - 1
                        </th>
                        <th title="Anggota ke - 2">
                            Anggota ke - 2
                        </th>
                    </tr>
                </thead>
...
<div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/pkmKelompok" class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST">
                    <div class="modal-body">
                        @csrf
                        @method("POST")
                        <div class="form-group m-form__group row ">
                            <label for="Thumbnail" class="col-4 col-form-label">
                                File PKM TOUR Kelompok
                            </label>
                            <div></div>
                            <div class="col-8">
                                <input type="file" name="kelompok" required="true"> 
                            </div>
                        </div>
                    </div>
