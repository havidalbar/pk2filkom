		...
		<div class="m-content">
			<div class="m-portlet m-portlet--mobile">
				<div class="m-portlet__body pt-1">
					<form action="{{ route('panel.kegiatan.pk2maba.pelanggaran.update', $pk2mabaPelanggaran->nim) }}"
							...
							<div class="form-group m-form__group row {{ $errors->has('nim') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="nim" placeholder="NIM" value="{{ $pk2mabaPelanggaran->nim }}" type="text"
							...
							<div class="form-group m-form__group row {{ $errors->has('ringan') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="ringan" placeholder="ringan" value="{{ $pk2mabaPelanggaran->ringan }}"
							...
							<div class="form-group m-form__group row {{ $errors->has('sedang') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="sedang" placeholder="sedang" value="{{ $pk2mabaPelanggaran->sedang }}"
							...
							<div class="form-group m-form__group row {{ $errors->has('berat') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="berat" placeholder="berat" value="{{ $pk2mabaPelanggaran->berat }}"
