...
@section('content')
	...
	<body style="background-image: url({{asset('img/bg-admin/bg-1.png')}}); background-size: 100% 100vh;"  class="m-page--boxed m-body--fixed m-header--static m-aside--offcanvas-default"  >
		<!-- begin:: Page -->
