                        ...
                        <div class="row">
                            <div class="col-xl-5">
                                ...
                                <div class="form-group m-form__group row {{ $errors->has('nilaiesai') ? 'has-danger' : '' }}">
                                    ...
                                    <div class="col-9">
                                        <input class="form-control m-input {{ $errors->has('nilaiesai') ? 'form-control-danger' : '' }}" name="nilaiesai" placeholder="nilaiesai" value="Nilai Esaitype" type="text" id="nilaiesai-text-input">
                                        {!! $errors->first('nilaiesai','<div class="form-control-feedback">:message</div>') !!}
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-7">
                                <div class="form-group m-form__group row {{ $errors->has('isiEsai') ? 'has-danger' : '' }}">
                                    <label for="isiEsai-text-input" class="col-2 col-form-label">
                                        Esai  
                                    </label>
                                    <div class="col-10">
                                        <textarea class="form-control m-input" readonly="true" rows="10">Isi Esai</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
