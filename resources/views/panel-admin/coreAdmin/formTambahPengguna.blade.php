                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('pengguna') ? 'has-danger' : '' }}">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input {{ $errors->has('pengguna') ? 'form-control-danger' : '' }}" name="username" placeholder="Nama pengguna" value="" type="text" id="pengguna-text-input">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('password') ? 'has-danger' : '' }}">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input {{ $errors->has('password') ? 'form-control-danger' : '' }}" name="password" placeholder="password" value="" type="password" id="password-text-input">
