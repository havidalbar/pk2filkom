                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('kegiatan') ? 'has-danger' : '' }}">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input {{ $errors->has('kegiatan') ? 'form-control-danger' : '' }}" name="kegiatan" placeholder="kegiatan" value="{{ $dataNilai->kegiatan }}" type="text" id="kegiatan-text-input">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('nilai') ? 'has-danger' : '' }}">
                            ...
                            <div class="col-10">
                                <input class="form-control m-input {{ $errors->has('nilai') ? 'form-control-danger' : '' }}" name="nilai" placeholder="nilai" value="{{ $dataNilai->nilai }}" type="text" id="kegiatan-text-input">
