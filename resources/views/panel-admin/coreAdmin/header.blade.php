...
<header class="m-grid__item	m-grid m-grid--desktop m-grid--hor-desktop  m-header ">
	<div
		class="m-grid__item m-grid__item--fluid m-grid m-grid--desktop m-grid--hor-desktop m-container m-container--responsive m-container--xxl">
				...
				<div class="m-stack m-stack--ver m-stack--general m-stack--inline">
					<div class="m-stack__item m-stack__item--middle m-brand__logo">
						<a href="{{ route('panel.index') }}" class="m-brand__logo-wrapper">
							<img alt="SiMaba!" src="{{ asset('img/logo/simaba4@4x.png') }}"
								style="height: 60px;width: 120px;" />
						</a>
					</div>
					<div
						class="m-stack__item m-stack__item--middle m-brand__tools m-dropdown m-dropdown--medium m-dropdown--arrow m-dropdown--header-bg-fill m-dropdown--align-right m-dropdown--mobile-full-width m-dropdown--skin-light">
						...
						@if ($menuKiri == true)
						<a id="m_aside_left_offcanvas_toggle" href="javascript:;"
						...
						<div class="m-brand__icon m--visible-tablet-and-mobile-inline-block m-dropdown m-dropdown--medium"
										...
										<div class="m-dropdown__body">
											<div class="m-dropdown__content">
												<ul class="m-nav m-nav--skin-light">
													...
													<li class="m-nav__item">
														<a href="{{route('panel.pengguna.ganti-password')}}"
															class="m-nav__link">
													...
													<li class="m-nav__item">
														...
														<form action="{{route('panel.logout')}}" id="logout_form"
															method="POST">
															{{ csrf_field() }}
														</form>
													</li>
