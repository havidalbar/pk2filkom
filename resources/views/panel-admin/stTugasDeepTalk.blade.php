        ...
        <div class="d-flex align-items-center">
            <div class="mr-auto">
                <h3 class="m-subheader__title" style="transform: translateY(10px);">
                    DATA 
                    <small>
                        Rekap tugas Deep Talk STARTUP ACADEMY
                    </small>
                </h3>
            </div>
        </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Import data tugas Deep Talk STARTUP ACADEMY
                    </h5>
                ...
                <form action="/stTugasDeepTalk" class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST">
                    <div class="modal-body">
                        @csrf
                        @method("POST")
                        <div class="form-group m-form__group row ">
                            <label for="Thumbnail" class="col-4 col-form-label">
                                File STARTUP ACADEMY TUGAS Deep Talk
                            </label>
                            <div></div>
                            <div class="col-8">
                                <input type="file" name="tugasDt" required="true"> 
                            </div>
                        </div>
                    </div>
