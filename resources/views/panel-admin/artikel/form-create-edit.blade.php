                    ...
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row {{ $errors->has('artikel') ? 'has-danger' : '' }}">
                            ...
                            <div class="col-10">
                                <input name="judul" class="form-control m-input {{ $errors->has('artikel') ? 'form-control-danger' : '' }}" name="artikel" placeholder="Nama artikel" value="{{ old('artikel') ?? ($artikel->judul ?? '') }}" type="text" id="artikel-text-input">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <label for="Deskripsi" class="col-2 col-form-label">
                                Deskripsi
							</label>
							<div class="col-10">
								<script src="https://cdn.ckeditor.com/ckeditor5/12.1.0/decoupled-document/ckeditor.js"></script>
								...
								<div id="editor" style="border: 1px solid grey"><?= $artikel->deskripsi ?? '' ?></div>
