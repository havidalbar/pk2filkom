            ...
            <table class="m-datatable" id="html_table" width="100%">
                <thead>
                    <tr>
                        ...
                        <th title="Nilai Rangkaian PKM TOUR Ke - 4">
                            Sedang
                        </th>
                        <th title="Nilai Rangkaian PKM TOUR Ke - 5">
                            Berat
                        </th>
                        <th title="Field #4">
                            Opsi
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="First group">
                                <a href="/editPkmPelanggaran" class="m-btn btn btn-warning">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">
                        Import data pelanggaran PKM TOUR
                    </h5>
                ...
                <form action="/pkmPelanggaran" class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST">
                    <div class="modal-body">
                        @csrf
                        @method("POST")
                        <div class="form-group m-form__group row ">
                            <label for="Thumbnail" class="col-4 col-form-label">
                                File PKM TOUR PELANGGARAN
                            </label>
                            <div></div>
                            <div class="col-8">
