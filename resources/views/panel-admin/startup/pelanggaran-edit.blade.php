		...
		<div class="m-content">
			<div class="m-portlet m-portlet--mobile">
				<div class="m-portlet__body pt-1">
					<form action="{{ route('panel.kegiatan.startup.pelanggaran.update', $startupPelanggaran->nim) }}"
							...
							<div class="form-group m-form__group row {{ $errors->has('nim') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="nim" placeholder="NIM" value="{{ $startupPelanggaran->nim }}" type="text"
							...
							<div class="form-group m-form__group row {{ $errors->has('ringan') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="ringan" placeholder="ringan" value="{{ $startupPelanggaran->ringan }}"
							...
							<div class="form-group m-form__group row {{ $errors->has('sedang') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="sedang" placeholder="sedang" value="{{ $startupPelanggaran->sedang }}"
							...
							<div class="form-group m-form__group row {{ $errors->has('berat') ? 'has-danger' : '' }}">
								...
								<div class="col-9">
									<input
										...
										name="berat" placeholder="berat" value="{{ $startupPelanggaran->berat }}"
