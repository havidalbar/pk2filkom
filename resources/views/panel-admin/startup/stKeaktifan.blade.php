...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-portlet__body pt-1">
            ...
            <table class="m-datatable" id="html_table" width="100%">
                ...
                <tbody>
                    @for($i=0;$i<count($startupKeaktifans);$i++)
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="First group">
                                <a href="{{route('panel.kegiatan.startup.keaktifan.edit',$startupKeaktifans[$i]->nim)}}" class="m-btn btn btn-warning">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <form action="{{route('panel.kegiatan.startup.keaktifan.destroy',$startupKeaktifans[$i]->nim)}}" class="m-btn btn btn-danger" method="POST">
                                    {{csrf_field()}}
