            ...
            <table class="m-datatable" id="html_table" width="100%">
                <thead>
                    <tr>
                        ...
                        <th title="Nilai Rangkaian ACADEMY KEAKTIFAN Ke - 3">
                            Ringgan
                        </th>
                        <th title="Nilai Rangkaian ACADEMY KEAKTIFAN Ke - 4">
                            Sedang
                        </th>
                        <th title="Nilai Rangkaian ACADEMY KEAKTIFAN Ke - 5">
                            Berat
                        </th>
                        <th title="Field #4">
                            Opsi
                ...
                <tbody>
                    @for($i=0;$i<count($startupPelanggarans);$i++)
                    <tr>
                        <td>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="First group">
                                <a href="{{route('panel.kegiatan.startup.pelanggaran.edit',$startupPelanggarans[$i]->nim)}}" class="m-btn btn btn-warning">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <form action="{{route('panel.kegiatan.startup.pelanggaran.destroy',$startupPelanggarans[$i]->nim)}}" class="m-btn btn btn-danger" method="POST">
                                    {{csrf_field()}}
...
<div class="modal fade" id="import" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="/stPelanggaran" class="m-form m-form--state m-form--fit m-form--label-align-right" method="POST">
