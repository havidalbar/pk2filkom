        ...
        <div class="accordion" id="accordionFAQ">
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionFAQ">
                    <div class="card-body">
                        A : PK2MABA merupakan kegiatan pengenalan kehidupan kampus pada mahsiswa baru, sedangkan Startup
                        Academy lanjutan kegiatan dari PK2MABA yang merupakan kegiatan pembekalan seputar hal-hal
                        terkait dunia perkuliahan agar mahasiswa baru FILKOM dapat mengembangkan potensinya
                    </div>
                </div>
            </div>
            <div class="card">
