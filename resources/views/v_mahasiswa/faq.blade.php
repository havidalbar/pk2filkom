            ...
            <div class="card">
                <div class="card-header" id="headingOne">
                    ...
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        Q : Apa itu PK2MABA & Startup Academy dan Apa Perbedaan Keduanya?
                    </button>
                    <!-- </h2> -->
                </div>
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionFAQ">
                    <div class="card-body">
                        A : PK2MABA merupakan kegiatan pengenalan kehidupan kampus pada mahsiswa baru, sedangkan Startup Academy lanjutan kegiatan dari PK2MABA yang merupakan kegiatan pembekalan seputar hal-hal terkait dunia perkuliahan agar mahasiswa baru FILKOM dapat mengembangkan potensinya
                    </div>
                </div>
            </div>
            <div class="card">
                <div class="card-header" id="headingTwo">
                    ...
                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        Q : Apakah Wajib Untuk Mengikuti Seluruh Rangkaian PK2MABA & Startup Academy?
                    </button>
                    <!-- </h2> -->
                </div>
